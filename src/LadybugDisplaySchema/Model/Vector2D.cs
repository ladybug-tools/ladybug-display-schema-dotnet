...
namespace LadybugDisplaySchema
{
    ...
    public partial class Vector2D : OpenAPIGenBaseModel, IEquatable<Vector2D>, IValidatableObject
    {
        /// <summary>
        ...
        public override string Type { get; protected set; }  = "Vector2D";
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^Vector2D$", RegexOptions.CultureInvariant);
