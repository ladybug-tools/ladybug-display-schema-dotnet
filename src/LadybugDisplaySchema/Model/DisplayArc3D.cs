...
namespace LadybugDisplaySchema
{
    ...
    public partial class DisplayArc3D : DisplayBaseModel, IEquatable<DisplayArc3D>, IValidatableObject
    {
        /// <summary>
        ...
        ) : base(userData: userData)// BaseClass
        {
            ...
            this.Geometry = geometry ?? throw new ArgumentNullException("geometry is a required property for DisplayArc3D and cannot be null");
        ...
        public override string Type { get; protected set; }  = "DisplayArc3D";
        ...
        /// </summary>
        /// <value>Arc3D for the geometry.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DisplayArc3D$", RegexOptions.CultureInvariant);
