...
namespace LadybugDisplaySchema
{
    ...
    public partial class DisplayPolyline3D : DisplayBaseModel, IEquatable<DisplayPolyline3D>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="geometry">Polyline3D for the geometry. (required).</param>
        ...
        (
           Color color, Polyline3D geometry, // Required parameters
        ...
        ) : base(userData: userData)// BaseClass
        {
            ...
            this.Color = color ?? throw new ArgumentNullException("color is a required property for DisplayPolyline3D and cannot be null");
            // to ensure "geometry" is required (not null)
            this.Geometry = geometry ?? throw new ArgumentNullException("geometry is a required property for DisplayPolyline3D and cannot be null");
        ...
        public override string Type { get; protected set; }  = "DisplayPolyline3D";
        ...
        /// </summary>
        /// <value>Polyline3D for the geometry.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DisplayPolyline3D$", RegexOptions.CultureInvariant);
