...
namespace LadybugDisplaySchema
{
    ...
    public partial class DisplayPoint3D : DisplayBaseModel, IEquatable<DisplayPoint3D>, IValidatableObject
    {
        /// <summary>
        ...
        (
           Color color, Point3D geometry, // Required parameters
            string layer= default, Object userData= default, AnyOf<Default, double> radius= default// Optional parameters
        ...
        public override string Type { get; protected set; }  = "DisplayPoint3D";
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DisplayPoint3D$", RegexOptions.CultureInvariant);
