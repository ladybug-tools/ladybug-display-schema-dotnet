...
namespace LadybugDisplaySchema
{
    ...
    public partial class Mesh2D : OpenAPIGenBaseModel, IEquatable<Mesh2D>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="Mesh2D" /> class.
        /// </summary>
        /// <param name="vertices">A list of points representing the vertices of the mesh. The list should include at least 3 points and each point should be a list of 2 (x, y) values. (required).</param>
        ...
        ) : base()// BaseClass
        {
            ...
            this.Vertices = vertices ?? throw new ArgumentNullException("vertices is a required property for Mesh2D and cannot be null");
            // to ensure "faces" is required (not null)
            this.Faces = faces ?? throw new ArgumentNullException("faces is a required property for Mesh2D and cannot be null");
            this.Colors = colors;
        ...
        public override string Type { get; protected set; }  = "Mesh2D";
        ...
        /// </summary>
        /// <value>A list of points representing the vertices of the mesh. The list should include at least 3 points and each point should be a list of 2 (x, y) values.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^Mesh2D$", RegexOptions.CultureInvariant);
