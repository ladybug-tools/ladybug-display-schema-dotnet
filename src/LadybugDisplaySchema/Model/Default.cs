...
namespace LadybugDisplaySchema
{
    ...
    public partial class Default : OpenAPIGenBaseModel, IEquatable<Default>, IValidatableObject
    {
        /// <summary>
        ...
        public override string Type { get; protected set; }  = "Default";
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^Default$", RegexOptions.CultureInvariant);
