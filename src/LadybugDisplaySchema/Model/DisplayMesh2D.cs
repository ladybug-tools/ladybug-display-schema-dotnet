...
namespace LadybugDisplaySchema
{
    ...
    public partial class DisplayMesh2D : DisplayBaseModel, IEquatable<DisplayMesh2D>, IValidatableObject
    {
        ...
        (
           Color color, Mesh2D geometry, // Required parameters
        ...
        ) : base(userData: userData )// BaseClass
        {
            ...
            this.Color = color ?? throw new ArgumentNullException("color is a required property for DisplayMesh2D and cannot be null");
