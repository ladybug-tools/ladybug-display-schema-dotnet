...
namespace LadybugDisplaySchema
{
    ...
    public partial class DisplayArc2D : DisplayBaseModel, IEquatable<DisplayArc2D>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="geometry">Arc2D for the geometry. (required).</param>
        ...
        public DisplayArc2D
        (
           Color color, Arc2D geometry, // Required parameters
        ...
        ) : base(layer: layer, userData: userData )// BaseClass
        {
            ...
            this.Color = color ?? throw new ArgumentNullException("color is a required property for DisplayArc2D and cannot be null");
            // to ensure "geometry" is required (not null)
            this.Geometry = geometry ?? throw new ArgumentNullException("geometry is a required property for DisplayArc2D and cannot be null");
        ...
        public override string Type { get; protected set; }  = "DisplayArc2D";
        ...
        /// </summary>
        /// <value>Arc2D for the geometry.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^DisplayArc2D$", RegexOptions.CultureInvariant);
