...
namespace LadybugDisplaySchema
{
    ...
    public static class LegendColorSet
    {
        ...
        public static Dictionary<string, List<Color>> GetUserColorSets()
        {
            ...
            var legend = LBT.Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, List<Color>>>(json);
            return legend;
        }

        public static bool SaveUserColorSet(string name, List<Color> colors)
        {
            var userFile = GetUserPresetFilePath();
            var dic = new Dictionary<string, List<Color>>();
            if (System.IO.File.Exists(userFile))
