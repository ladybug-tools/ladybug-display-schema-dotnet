...
namespace LadybugDisplaySchema
{
    ...
    /// </summary>
    [Summary(@"A single line segment face in 3D space with display properties.")]
    [System.Serializable]
    [DataContract(Name = "DisplayLineSegment3D")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class DisplayLineSegment3D : DisplayBaseModel, System.IEquatable<DisplayLineSegment3D>
    {
        /// <summary>
        ...
        /// <param name="geometry">LineSegment3D for the geometry.</param>
        ...
        (
            Color color, LineSegment3D geometry, object userData = default, AnyOf<Default, double> lineWidth = default, LineTypes lineType = LineTypes.Continuous
        ) : base(userData: userData)
        {
            this.Color = color ?? throw new System.ArgumentNullException("color is a required property for DisplayLineSegment3D and cannot be null");
            this.Geometry = geometry ?? throw new System.ArgumentNullException("geometry is a required property for DisplayLineSegment3D and cannot be null");
        ...
        /// </summary>
        [Summary(@"LineSegment3D for the geometry.")]
        [Required] // For validation after deserialization
        // [System.Text.Json.Serialization.JsonRequired] // For System.Text.Json 
