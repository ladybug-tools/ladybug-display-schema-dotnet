...
namespace LadybugDisplaySchema
{
    ...
    /// </summary>
    [Summary(@"A polyline in 3D space with display properties.")]
    [System.Serializable]
    [DataContract(Name = "DisplayPolyline3D")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class DisplayPolyline3D : DisplayBaseModel, System.IEquatable<DisplayPolyline3D>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DisplayPolyline3D" /> class.
        /// </summary>
        [LBT.Newtonsoft.Json.JsonConstructorAttribute]
        // [System.Text.Json.Serialization.JsonConstructor] // for future switching to System.Text.Json
        protected DisplayPolyline3D() 
        { 
            // Set readonly properties with defaultValue
            this.Type = "DisplayPolyline3D";
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="DisplayPolyline3D" /> class.
        /// </summary>
        /// <param name="color">Color for the geometry.</param>
        /// <param name="geometry">Polyline3D for the geometry.</param>
        ...
        public DisplayPolyline3D
        (
            Color color, Polyline3D geometry, object userData = default, AnyOf<Default, double> lineWidth = default, LineTypes lineType = LineTypes.Continuous
        ) : base(userData: userData)
        {
            this.Color = color ?? throw new System.ArgumentNullException("color is a required property for DisplayPolyline3D and cannot be null");
            this.Geometry = geometry ?? throw new System.ArgumentNullException("geometry is a required property for DisplayPolyline3D and cannot be null");
            ...
            if (this.GetType() == typeof(DisplayPolyline3D))
        ...
        /// </summary>
        [Summary(@"Polyline3D for the geometry.")]
        [Required] // For validation after deserialization
        // [System.Text.Json.Serialization.JsonRequired] // For System.Text.Json 
        ...
        public Polyline3D Geometry { get; set; }
        ...
        /// </summary>
        /// <returns>DisplayPolyline3D object</returns>
        public static DisplayPolyline3D FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<DisplayPolyline3D>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DisplayPolyline3D object</returns>
        public virtual DisplayPolyline3D DuplicateDisplayPolyline3D()
        {
        ...
        {
            return DuplicateDisplayPolyline3D();
        }
        ...
        public override bool Equals(object input)
        {
            ...
            return this.Equals(input as DisplayPolyline3D);
        }


        /// <summary>
        /// Returns true if DisplayPolyline3D instances are equal
        /// </summary>
        /// <param name="input">Instance of DisplayPolyline3D to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DisplayPolyline3D input)
        {
            if (input == null)
                return false;
