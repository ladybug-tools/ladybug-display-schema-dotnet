...
namespace LadybugDisplaySchema
{
    ...
    /// </summary>
    [Summary(@"A cone object with display properties.")]
    [System.Serializable]
    [DataContract(Name = "DisplayCone")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class DisplayCone : DisplayBaseModel, System.IEquatable<DisplayCone>
    {
        /// <summary>
        ...
        /// <param name="geometry">Cone for the geometry.</param>
        ...
        public DisplayCone
        (
            Color color, Cone geometry, object userData = default, DisplayModes displayMode = DisplayModes.Surface
        ) : base(userData: userData)
        {
            this.Color = color ?? throw new System.ArgumentNullException("color is a required property for DisplayCone and cannot be null");
            this.Geometry = geometry ?? throw new System.ArgumentNullException("geometry is a required property for DisplayCone and cannot be null");
