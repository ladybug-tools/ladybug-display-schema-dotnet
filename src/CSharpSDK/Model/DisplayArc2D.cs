...
namespace LadybugDisplaySchema
{
    ...
    /// </summary>
    [Summary(@"A single arc or circle in 2D space with display properties.")]
    [System.Serializable]
    [DataContract(Name = "DisplayArc2D")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class DisplayArc2D : DisplayBaseModel, System.IEquatable<DisplayArc2D>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DisplayArc2D" /> class.
        /// </summary>
        [LBT.Newtonsoft.Json.JsonConstructorAttribute]
        // [System.Text.Json.Serialization.JsonConstructor] // for future switching to System.Text.Json
        protected DisplayArc2D() 
        { 
            // Set readonly properties with defaultValue
            this.Type = "DisplayArc2D";
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="DisplayArc2D" /> class.
        /// </summary>
        /// <param name="color">Color for the geometry.</param>
        /// <param name="geometry">Arc2D for the geometry.</param>
        ...
        public DisplayArc2D
        (
            Color color, Arc2D geometry, object userData = default, AnyOf<Default, double> lineWidth = default, LineTypes lineType = LineTypes.Continuous
        ) : base(userData: userData)
        {
            this.Color = color ?? throw new System.ArgumentNullException("color is a required property for DisplayArc2D and cannot be null");
            this.Geometry = geometry ?? throw new System.ArgumentNullException("geometry is a required property for DisplayArc2D and cannot be null");
            ...
            if (this.GetType() == typeof(DisplayArc2D))
        ...
        /// </summary>
        [Summary(@"Arc2D for the geometry.")]
        [Required] // For validation after deserialization
        // [System.Text.Json.Serialization.JsonRequired] // For System.Text.Json 
        ...
        /// </summary>
        /// <returns>DisplayArc2D object</returns>
        public static DisplayArc2D FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<DisplayArc2D>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>DisplayArc2D object</returns>
        public virtual DisplayArc2D DuplicateDisplayArc2D()
        {
        ...
        public override bool Equals(object input)
        {
            ...
            return this.Equals(input as DisplayArc2D);
        }


        /// <summary>
        /// Returns true if DisplayArc2D instances are equal
        /// </summary>
        /// <param name="input">Instance of DisplayArc2D to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DisplayArc2D input)
        {
            if (input == null)
                return false;
