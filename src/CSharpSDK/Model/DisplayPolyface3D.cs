...
namespace LadybugDisplaySchema
{
    ...
    /// </summary>
    [Summary(@"A Polyface in 3D space with display properties.")]
    [System.Serializable]
    [DataContract(Name = "DisplayPolyface3D")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class DisplayPolyface3D : DisplayBaseModel, System.IEquatable<DisplayPolyface3D>
    {
        /// <summary>
        ...
        /// <param name="geometry">Polyface3D for the geometry.</param>
        ...
        (
            Color color, Polyface3D geometry, object userData = default, DisplayModes displayMode = DisplayModes.Surface
        ) : base(userData: userData)
        {
            this.Color = color ?? throw new System.ArgumentNullException("color is a required property for DisplayPolyface3D and cannot be null");
            this.Geometry = geometry ?? throw new System.ArgumentNullException("geometry is a required property for DisplayPolyface3D and cannot be null");
        ...
        /// </summary>
        [Summary(@"Polyface3D for the geometry.")]
        [Required] // For validation after deserialization
        // [System.Text.Json.Serialization.JsonRequired] // For System.Text.Json 
