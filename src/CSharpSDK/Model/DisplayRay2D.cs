...
namespace LadybugDisplaySchema
{
    ...
    /// </summary>
    [Summary(@"A ray object in 2D space with display properties.")]
    [System.Serializable]
    [DataContract(Name = "DisplayRay2D")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class DisplayRay2D : DisplayBaseModel, System.IEquatable<DisplayRay2D>
    {
        /// <summary>
        ...
        /// <param name="geometry">Ray2D for the geometry.</param>
        /// <param name="userData">Optional dictionary of user data associated with the object.All keys and values of this dictionary should be of a standard data type to ensure correct serialization of the object (eg. str, float, int, list).</param>
        public DisplayRay2D
        (
            Color color, Ray2D geometry, object userData = default
        ) : base(userData: userData)
        {
            this.Color = color ?? throw new System.ArgumentNullException("color is a required property for DisplayRay2D and cannot be null");
            this.Geometry = geometry ?? throw new System.ArgumentNullException("geometry is a required property for DisplayRay2D and cannot be null");
        ...
        /// </summary>
        [Summary(@"Ray2D for the geometry.")]
        [Required] // For validation after deserialization
        // [System.Text.Json.Serialization.JsonRequired] // For System.Text.Json 
