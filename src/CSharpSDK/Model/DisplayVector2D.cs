...
namespace LadybugDisplaySchema
{
    ...
    public partial class DisplayVector2D : DisplayBaseModel, System.IEquatable<DisplayVector2D>
    {
        ...
        /// <param name="geometry">Vector2D for the geometry.</param>
        /// <param name="userData">Optional dictionary of user data associated with the object.All keys and values of this dictionary should be of a standard data type to ensure correct serialization of the object (eg. str, float, int, list).</param>
        public DisplayVector2D
        (
            Color color, Vector2D geometry, object userData = default
        ) : base(userData: userData)
        {
            this.Color = color ?? throw new System.ArgumentNullException("color is a required property for DisplayVector2D and cannot be null");
            this.Geometry = geometry ?? throw new System.ArgumentNullException("geometry is a required property for DisplayVector2D and cannot be null");
