...
namespace LadybugDisplaySchema
{
    ...
    public partial class Default : OpenAPIGenBaseModel, System.IEquatable<Default>
    {
        ...
        ) : base()
        {
            ...
            if (this.GetType() == typeof(Default))
        ...
        public static Default FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<Default>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>Default object</returns>
        public virtual Default DuplicateDefault()
        {
