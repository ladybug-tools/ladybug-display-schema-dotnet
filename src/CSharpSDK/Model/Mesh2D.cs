...
namespace LadybugDisplaySchema
{
    ...
    public partial class Mesh2D : OpenAPIGenBaseModel, System.IEquatable<Mesh2D>
    {
        ...
        /// Initializes a new instance of the <see cref="Mesh2D" /> class.
        /// </summary>
        /// <param name="vertices">A list of points representing the vertices of the mesh. The list should include at least 3 points and each point should be a list of 2 (x, y) values.</param>
        ...
        {
            this.Vertices = vertices ?? throw new System.ArgumentNullException("vertices is a required property for Mesh2D and cannot be null");
            this.Faces = faces ?? throw new System.ArgumentNullException("faces is a required property for Mesh2D and cannot be null");
            this.Colors = colors;
        ...
        /// </summary>
        /// <returns>Mesh2D object</returns>
        public static Mesh2D FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<Mesh2D>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>Mesh2D object</returns>
        public virtual Mesh2D DuplicateMesh2D()
        {
        ...
        public override bool Equals(object input)
        {
            ...
            return this.Equals(input as Mesh2D);
        }


        /// <summary>
        /// Returns true if Mesh2D instances are equal
        /// </summary>
        /// <param name="input">Instance of Mesh2D to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Mesh2D input)
        {
            if (input == null)
                return false;
