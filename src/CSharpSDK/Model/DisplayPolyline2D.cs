...
namespace LadybugDisplaySchema
{
    ...
    public partial class DisplayPolyline2D : DisplayBaseModel, System.IEquatable<DisplayPolyline2D>
    {
        ...
        /// <param name="geometry">Polyline2D for the geometry.</param>
        ...
        (
            Color color, Polyline2D geometry, object userData = default, AnyOf<Default, double> lineWidth = default, LineTypes lineType = LineTypes.Continuous
        ) : base(userData: userData)
        {
            this.Color = color ?? throw new System.ArgumentNullException("color is a required property for DisplayPolyline2D and cannot be null");
            this.Geometry = geometry ?? throw new System.ArgumentNullException("geometry is a required property for DisplayPolyline2D and cannot be null");
