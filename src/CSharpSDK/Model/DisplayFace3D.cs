...
namespace LadybugDisplaySchema
{
    ...
    /// </summary>
    [Summary(@"A single planar face in 3D space with display properties.")]
    [System.Serializable]
    [DataContract(Name = "DisplayFace3D")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class DisplayFace3D : DisplayBaseModel, System.IEquatable<DisplayFace3D>
    {
        /// <summary>
        ...
        /// <param name="geometry">Face3D for the geometry.</param>
        ...
        (
            Color color, Face3D geometry, object userData = default, DisplayModes displayMode = DisplayModes.Surface
        ) : base(userData: userData)
        {
            this.Color = color ?? throw new System.ArgumentNullException("color is a required property for DisplayFace3D and cannot be null");
            this.Geometry = geometry ?? throw new System.ArgumentNullException("geometry is a required property for DisplayFace3D and cannot be null");
        ...
        /// </summary>
        [Summary(@"Face3D for the geometry.")]
        [Required] // For validation after deserialization
        // [System.Text.Json.Serialization.JsonRequired] // For System.Text.Json 
