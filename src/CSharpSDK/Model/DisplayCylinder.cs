...
namespace LadybugDisplaySchema
{
    ...
    /// </summary>
    [Summary(@"A cylinder object with display properties.")]
    [System.Serializable]
    [DataContract(Name = "DisplayCylinder")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class DisplayCylinder : DisplayBaseModel, System.IEquatable<DisplayCylinder>
    {
        /// <summary>
        ...
        /// <param name="geometry">Cylinder for the geometry.</param>
        ...
        (
            Color color, Cylinder geometry, object userData = default, DisplayModes displayMode = DisplayModes.Surface
        ) : base(userData: userData)
        {
            this.Color = color ?? throw new System.ArgumentNullException("color is a required property for DisplayCylinder and cannot be null");
            this.Geometry = geometry ?? throw new System.ArgumentNullException("geometry is a required property for DisplayCylinder and cannot be null");
        ...
        /// </summary>
        [Summary(@"Cylinder for the geometry.")]
        [Required] // For validation after deserialization
        // [System.Text.Json.Serialization.JsonRequired] // For System.Text.Json 
