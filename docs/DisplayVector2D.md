...
# LadybugDisplaySchema.Model.DisplayVector2D
...
**Geometry** | [**Vector2D**](Vector2D.md) | Vector2D for the geometry. | 
**Type** | **string** |  | [optional] [readonly] [default to "DisplayVector2D"]
