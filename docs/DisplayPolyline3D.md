...
# LadybugDisplaySchema.Model.DisplayPolyline3D
...
**Geometry** | [**Polyline3D**](Polyline3D.md) | Polyline3D for the geometry. | 
...
**Type** | **string** |  | [optional] [readonly] [default to "DisplayPolyline3D"]
